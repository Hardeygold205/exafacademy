    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4">
      <div className="max-w-md w-full text-center space-y-8 p-8 rounded-2xl border border-stone-100 shadow-xl shadow-stone-200/50">
        ...
        <div className="space-y-4 pt-4">
          <Button 
            asChild
            className="w-full h-12 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl font-semibold shadow-lg shadow-emerald-700/20 transition-all"
          >
            <a href="https://mail.google.com" target="_blank" rel="noreferrer" className="flex items-center justify-center gap-2">
        ...
        <div className="pt-8 border-t border-stone-50">
          <p className="text-xs text-stone-400">
            ...
            <button onClick={() => router.push("/register")} className="ml-1 text-emerald-600 hover:underline font-medium">
              signup again
            </button>
          </p>
        </div>
